...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mobservable = __webpack_require__(158);
	...
	var reactMixin = __webpack_require__(161);
	exports.B2 = B2;
	...
	var GroupNew = (function (_React$Component) {
	  ...
	  function GroupNew(props) {
	    ...
	    this.render = function () {
	      ...
	      return _react2['default'].createElement('div', { style: { marginLeft: 5 } }, _react2['default'].createElement('label', null, 'Player defined group name:  ', _react2['default'].createElement('input', { type: 'text', id: 'cow', onKeyDown: _this.handleEnter.bind(_this),
	...
	var Fibonacci = (function (_React$Component2) {
	  ...
	  function Fibonacci(props) {
	    ...
	    this.render = function () {
	      ...
	      return _react2['default'].createElement('div', { style: { marginLeft: 5 } }, _react2['default'].createElement('label', null, 'Enter a number:  ', _react2['default'].createElement('input', { autoFocus: true, type: 'text', id: 'cow', onKeyDown: _this2.handleEnter.bind(_this2),
	...
	var B2 = (function (_React$Component3) {
	  ...
	  function B2(props) {
	    ...
	    this.render = function () {
	      ...
	      return _react2['default'].createElement('div', { style: { backgroundColor: '#000', height: 2800, color: 'turquoise' } }, _react2['default'].createElement('div', { style: { width: '40%', marginLeft: 85, float: 'right', marginRight: 2 } }, _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'Fibonacci numbers ( [temp][1] ):', _react2['default'].createElement('button', { style: _this3.style8(cr27, cr270, cr28) }, temp[1]), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'Value of data.x:', _react2['default'].createElement('button', { style: _this3.style8(cr27, cr270, cr28), onClick: function onClick() {
	          increaseX();
	        },
	      ...
	      }, x), '**************************', _react2['default'].createElement('h1', null, 'More Fibonacci Numbers'), _react2['default'].createElement('h2', null, ' fib(', p, ') = ', q, ' '), _react2['default'].createElement(Fibonacci, { fib: _this3.blib }, ' '), 'Elapsed time = ', t, ' milliseconds.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'The computer code is at ', _react2['default'].createElement('a', { style: { color: 'red' }, href: 'https://github.com/dschalk/mobservable-react-buttons' }, 'mobservable-react-buttons'), '**************************', _react2['default'].createElement('h2', { style: { textAlign: 'center' } }, 'Rollover Buttons'), 'Current Group:', _react2['default'].createElement('button', { style: _this3.style8('blue', 'lightgreen', 'red') }, group), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('button', { onClick: function onClick() {
	        ...
	        style: _this3.style8(_this3.mouse.Abackground, _this3.mouse.Aborder, _this3.mouse.Acolor) }, 'GroupA'), _react2['default'].createElement('button', { onClick: function onClick() {
	        ...
	        style: _this3.style8(_this3.mouse.Bbackground, _this3.mouse.Bborder, _this3.mouse.Bcolor) }, 'GroupB'), _react2['default'].createElement('button', { onClick: function onClick() {
	        ...
	        style: _this3.style8(_this3.mouse.Cbackground, _this3.mouse.Cborder, _this3.mouse.Ccolor) }, 'GroupC'), _react2['default'].createElement('button', { onClick: function onClick() {
	        ...
	        style: _this3.style8(_this3.mouse.Sbackground, _this3.mouse.Sborder, _this3.mouse.Scolor) }, 'solo'), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement(GroupNew, { key: 'GroupNew', setGroup: function setGroup(x) {
	          _this3.data.group = x;
	        }, name: _this3.data.name }), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'The buttons above are inter-connected with one another and with the input box. Click the buttons and enter some text to see how they interact. These are dumned-down buttons from my ', _react2['default'].createElement('a', { target: ' _blank', style: { color: 'red' }, href: 'http://machinegun.ninja' }, 'Game of Score'), ' Haskell websockets multiplayer math game. The buttons presented here demonstrate the full functionality of the rollover effects, along with some other features that don\'t come with HTML select/option forms. When the value of \'data.test\' is \'true\', data.groupWatch() automatically changes button highlighting when the value of \'data.group\' changes. When the mouse enters a button, data.test is set to \'false\' allowing the rollover effect to override \'data.groupWatch()\'.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'The movement from MVC frameworks to Facebook\'s React to Mr. Weststrate\'s mobservable-React hybrid seems to portend a progression into a future hybrid not only free from Flux and its progeny, but possibly free even from React\'s \'state\' object, which at first appears to be essential. Now it could be that Facebook\'s website needs Flux, and would flounder if it were to substitue mobservable for its dispatchers, stores, state object, and Flux. My websockets-react project isn\'t handling much traffic, but it is fairly complex. The more I convert over to mobservable, the easier it gets to follow code logic and add features. I haven\'t noticed an deterioration in performance, and I suspect that it can handle heavier loads than the earlier version which held more tightly to Facebook\'s patterns.  As I move things out of the \'state\' object and into mobservable objects, I remove the associated \'setState\' code, along with the getter code, and install methods in mobservable-encapsulated objects that cause the application to take care of itself automatically. That is what I did with these buttons.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), _react2['default'].createElement('button', { style: _this3.style9(dsp, cr38, cr370, cr38), onClick: function onClick() {
	          _this3.twoTimes();
	        },
	        onMouseEnter: function onMouseEnter() {
	      ...
	      }, x)), _react2['default'].createElement('div', { style: { width: '45%', float: 'left', marginLeft: 12 } }, _react2['default'].createElement('h2', { style: { textAlign: 'left' } }, 'Sensitivity of Observable Functions and Methods'), _react2['default'].createElement('p', null, 'When React renders the the main component (B2), reactive functions merely mentioned in the render function are executed. The variable \'data.x\' is not involved in the method \'g\', which computes sequential Fibonacci numbers, yet incrementing x causes the next fibonacci number to be displayed. In fact, just moving the mouse pointer in or out of the \'Value of data.x" button causes the sequence to increment. You dont\'s have to click the button.'), _react2['default'].createElement('p', null, 'Rolling over any rollover button or entering text causes the sequence to progress, unless the rollover or text entry doesn\'t change anything. It is reassuring to see that if a rollover button is already selected, rolling over it or clicking it to select an already-selected group does not increase the Fibonacci number. That means there is no unnecessary rendering'), _react2['default'].createElement('p', null, 'The line \'let g = this.data.g\' in \'render\' is all it takes to invoke this behavior. Note that \'g\' is not called and its argument is not modified (that is, not until g modifies it). Being aware of this behavior facilitates writing concise code and avoiding magical bugs. '), 'The line \'let increaseX = this.data.increaseX\' is also present in \'render()\', but rendering does not trigger its execution. The relevant difference between \'increaseX\' and \'g\' from a practical perspective is that \'g\' is defined inside of the data object but \'increaseX\' is incorporated into \'data\' externally with with the code: \'data.increaseX = ...\'. Another way of looking at this is to see that \'g\' was inside of \'data\' when it was encapsulated, but \'increaseX\' was tacked on after encapsulation. The precise explanation for this behavior can be found in the details of the code.', _react2['default'].createElement('br', null), _react2['default'].createElement('h1', null, 'More Fibonacci Numbers'), 'The 1475th number in the Fibonacci sequence is about the biggest number browsers can display.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'fib(1475) = 4.992254605477766e+307  ', _react2['default'].createElement('br', null), 'fib(1500) = Infinity', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'You might be interested in seeing how many milliseconds it takes your device to compute fib(1475) the first time, and then another couple of times. The first time after reloading is the slowest. Or maybe try 10000000. That\'s ten million. The display says "Infinity" but the mobservable function will performe ten million computations, mostly computing fib(Infinity) = Infinity or some such nonsense after it gets a little past fib(1475). A browser on modern desktop computer can perform the 10,000,000 computations in around 200 milliseconds (0.5 seconds).  ', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'Mobservable keeps track of state with (current / most recent) pairs (loosely speaking). If the current pair is (a,b), then my fibonacci routine sets the next one to (a+b, a). The next pair has numbers equalling (a+b+a, a+b) and so on and so forth ten million times, in 1.5 seconds. Using mobservable, I hardly had to write any code.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), 'With mobservable, there is no need to explicitly designate subscribers, as there would be with RxJS and Bacon. The buttons shown here work fine with React\'s state and props objects left empty. You might wonder why I use React at all. Mobservable doesn\'t rely on React. Well, this code is a snippet from my websockets-react project. The complete code is available at ', _react2['default'].createElement('a', { style: { color: 'red' }, href: 'https://github.com/dschalk/websockets-react' }, 'https://github.com/dschalk/websockets-react'), '. An explanation of the project is at ', _react2['default'].createElement('a', { style: { color: 'red' }, href: 'https://www.fpcomplete.com/user/dschalk/Websockets%20Game%20of%20Score' }, 'https://www.fpcomplete.com/user/dschalk/Websockets%20Game%20of%20Score'), '. My server is a modified Haskell Wai-Websockets server. Like mobservable, it does much in a very simple and elegant manner.', _react2['default'].createElement('br', null), _react2['default'].createElement('br', null), ' I used \'react_mixin\', but it is not necessary for the buttons. I used it to grab a React mixin out of \'node_modules\' to support autoFocus (\'autofocus\' in regular HTML).', _react2['default'].createElement('br', null), _react2['default'].createElement('h2', null, 'Unsubscribe'), 'You don\'t have to subscribe to anything, but it is easy to do something like RxJS\'s \'unsubscribe\'. After the first click, you get warned. After the second click, the button evaporates.'));
	    };
